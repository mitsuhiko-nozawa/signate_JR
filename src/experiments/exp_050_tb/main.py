...
def main():
    ...
    # =========================== calculate cv ===========================
    df_8_c = pd.read_csv("../../experiments/exp_042/val_preds/oof_preds.csv") 
    df_9_c = pd.read_csv("../../experiments/exp_043/val_preds/oof_preds.csv") 
    df_18_c = pd.read_csv("../../experiments/exp_044/val_preds/oof_preds.csv") 
    df_19_c = pd.read_csv("../../experiments/exp_045/val_preds/oof_preds.csv") 
    df_8_i = pd.read_csv("../../experiments/exp_046/val_preds/oof_preds.csv") 
    df_9_i = pd.read_csv("../../experiments/exp_047/val_preds/oof_preds.csv") 
    df_18_i = pd.read_csv("../../experiments/exp_048/val_preds/oof_preds.csv") 
    df_19_i = pd.read_csv("../../experiments/exp_049/val_preds/oof_preds.csv") 
    ...
    df_8_c = pd.read_csv("../../experiments/exp_042/preds/pred.csv") 
    df_9_c = pd.read_csv("../../experiments/exp_043/preds/pred.csv") 
    df_18_c = pd.read_csv("../../experiments/exp_044/preds/pred.csv") 
    df_19_c = pd.read_csv("../../experiments/exp_045/preds/pred.csv") 
    df_8_i = pd.read_csv("../../experiments/exp_046/preds/pred.csv") 
    df_9_i = pd.read_csv("../../experiments/exp_047/preds/pred.csv") 
    df_18_i = pd.read_csv("../../experiments/exp_048/preds/pred.csv") 
    df_19_i = pd.read_csv("../../experiments/exp_049/preds/pred.csv") 
    ...
    sub_df[["id", "pred_2"]].to_csv("sub_tabnet_1seed.csv", index=False, header=False)
    print("complete!!!")
