...
def main() -> None:
    ...
    # =========================== calculate cv ===========================
    df_8 = pd.read_csv("../../experiments/exp_022/val_preds/oof_preds.csv") 
    df_9 = pd.read_csv("../../experiments/exp_023/val_preds/oof_preds.csv") 
    df_18 = pd.read_csv("../../experiments/exp_024/val_preds/oof_preds.csv") 
    df_19 = pd.read_csv("../../experiments/exp_025/val_preds/oof_preds.csv") 
    ...
    # =========================== make submission ===========================
    df_8 = pd.read_csv("../../experiments/exp_022/preds/pred.csv") 
    df_9 = pd.read_csv("../../experiments/exp_023/preds/pred.csv") 
    df_18 = pd.read_csv("../../experiments/exp_024/preds/pred.csv") 
    df_19 = pd.read_csv("../../experiments/exp_025/preds/pred.csv") 
